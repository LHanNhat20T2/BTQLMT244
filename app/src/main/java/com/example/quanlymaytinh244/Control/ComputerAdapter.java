package com.example.quanlymaytinh244.Control;
...
import com.example.quanlymaytinh244.ListComputer;
import com.example.quanlymaytinh244.Model.Computer;
import com.example.quanlymaytinh244.R;
...
public class ComputerAdapter extends RecyclerView.Adapter<ComputerAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView;
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_computer_item, parent, false);
        ...
        public ViewHolder(View itemView) {
            ...
            btnEdit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    dialog.setContentView(R.layout.computer_custom);
                    dialog.show();
